  ...
  return (
    <div className=" md:flex  lg:space-x-20 lg:justify-center overflow-hidden md:items-center  md:space-x-4 relative  text-white bg-green-600 pt-10 px-6 md:pl-10 md:pt-20 md:px-0 ">
      <div  className="space-y-4  lg:max-w-[600px] lg:pl-20  ">
        <h3  data-aos="fade-up" data-aos-once="true" data-aos-duration="800" className=" uppercase font-light text-sm ">Boost your traffic</h3>
        <h4  data-aos="fade-up" data-aos-once="true" data-aos-duration="900" className=" text-2xl  md:text-3xl lg:text-4xl font-semibold">
          Increase your website traffic with our proven approach
        </h4>

        <div  data-aos="fade-up" data-aos-once="true" data-aos-duration="900" className="flex space-x-2">
        ...
        <div className="space-y-4 py-4 ">
          <div  data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
            <p className=" font-bold text-3xl">
              ...
              <CountUp scrollSpyOnce end={4379} className="text-3xl" enableScrollSpy />
            </p>
          ...
          <div  data-aos="fade-up" data-aos-once="true" data-aos-duration="1100">
            <p className=" font-bold text-3xl">
            <CountUp scrollSpyOnce end={99} className="text-3xl" enableScrollSpy />%
      ...
      <div data-aos="fade-left" data-aos-once="true" data-aos-duration="900" className="mt-4">
